...
class ArgParser():
    def __init__(self):
        ...
        self.proj_name = 'Text_translate'

        #Task arguments
        task_list = ['translate']
        self.parser.add_argument('--task', type = str, choices = task_list, default = 'translate',
        ...
        dataset_list = ['wmt2016']
        self.parser.add_argument('--task_dataset', type = str, choices = dataset_list, default = 'wmt2016',
        ...
        self.parser.add_argument('--proj_name', type = str, default = 'Text_Translation',
                                 help = 'Name of the project.')
        model_type_list = ['transformer', 'helsinki', 'helsinki_hand']
        self.parser.add_argument('--model_type', type = str, choices = model_type_list, default = 'transformer',
